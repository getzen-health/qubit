    ...
    private let sections: [(header: String, entries: [AnalyticsEntry])] = [
        (
            ...
            entries: [
                ...
                AnalyticsEntry(title: "Boxing Science", subtitle: "Punch biomechanics, energy systems, brain health & training physiology — Turner 2011: elite 4.8 kN punch force; Davis 2002: PCr+glycolytic = 90% early-round energy; McKee 2015: CTE in 80% of deceased boxers; Khanna 2006: VO₂max 58–68 mL/kg/min", icon: "figure.boxing", color: .red,
                               destination: AnyView(BoxingScienceView())),
                ...
                AnalyticsEntry(title: "Wrestling Science", subtitle: "Match physiology, takedown biomechanics, weight cutting & injury prevention — Yoon 2002: HR 175–190 bpm, lactate 8–14 mmol/L; Fogelholm 1994: 5% dehydration −9.5% anaerobic power; Wroble 1996: knee injuries 28% of all injuries", icon: "figure.wrestling", color: .indigo,
                               destination: AnyView(WrestlingScienceView())),
                ...
                AnalyticsEntry(title: "XC Skiing Science", subtitle: "World's highest VO₂max sport: physiology, polarized training & altitude — Ingjer 1991: Dæhlie 96 mL/kg/min; Seiler 2009: 80/20 polarization; Holmberg 2005: double-poling 500–700 W; Stray-Gundersen 1992: live-high-train-low +5% hemoglobin", icon: "figure.skiing.crosscountry", color: .cyan,
                               destination: AnyView(CrossCountrySkiingScienceView())),
                ...
                AnalyticsEntry(title: "Surfing Science", subtitle: "Paddle physiology, pop-up biomechanics, injury prevention & surf fitness — Farley 2012: paddling = 54% of session; Nathanson 2002: board impact = 55% of injuries; Mendez-Villanueva 2006: paddling at 70–78% VO₂max", icon: "wave.3.forward", color: .cyan,
                               destination: AnyView(SurfingScienceView())),
                ...
                AnalyticsEntry(title: "American Football Science", subtitle: "Positional demands, CTE science, strength & energy systems — Brechue 2010: NFL Combine profiles; McKee 2023: CTE in 110/111 donated brains; Mihalik 2011: neck strength −33% head acceleration; Davis 2004: WR VO₂max 52–60 mL/kg/min", icon: "football.fill", color: .brown,
                               destination: AnyView(AmericanFootballScienceView())),
                ...
                AnalyticsEntry(title: "Track & Field Science", subtitle: "Sprint biomechanics, energy systems by event, field events & periodization — Haugen 2019: 100m ground contact ≤80 ms; Jones 2000: 100m 100% anaerobic; Morin 2011: horizontal force key to sprint; Dapena 1988: Fosbury Flop physics", icon: "figure.run.circle", color: .orange,
                               destination: AnyView(TrackAndFieldScienceView())),
