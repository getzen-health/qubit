  ...
  async (_req, { user, query, supabase }) => {
    ...
    const doc = React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { style: styles.footer },
          'Generated by KQuarks · kquarks.app · This report is for informational purposes only and does not constitute medical advice.'
        )
      )
    )
    ...
    return new Response(new Uint8Array(buffer), {
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="kquarks-health-report.pdf"',
      },
