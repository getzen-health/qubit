...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Yoga Science', desc: 'Flexibility & joint health, pranayama & HRV, mental health neuroscience & aging — Cramer 2013: yoga reduces LBP 48%; Streeter 2010: 27% GABA increase; Brown 2009: slow breathing raises HRV 40–80%', href: '/yoga-science', emoji: '🔬' },
      ...
      { label: 'VO₂max Science', desc: 'Physiology, longevity, training protocols & Apple Watch accuracy — Mandsager 2018 JAMA: elite fitness = 5× lower mortality; Helgerud 2007: 4×4 HIIT = best VO₂max protocol; Kodama 2009: each 1 MET = 13% mortality reduction', href: '/vo2max-science', emoji: '🔬' },
      ...
      { label: 'Lactate Threshold Science', desc: 'Two-threshold physiology, zone training & LT improvement — Faude 2009: LT2 predicts 91% of marathon time variance; Seiler 2010: 80/20 polarized model; Buchheit 2007: DFA-α1 HRV detects LT non-invasively', href: '/lactate-threshold-science', emoji: '🔬' },
      ...
      { label: 'Boxing Science', desc: 'Punch biomechanics, energy systems, brain health & training physiology — Turner 2011: 4.8 kN punch force; Davis 2002: PCr+glycolytic = 90% early-round energy; McKee 2015: CTE in 80% of deceased boxers; Khanna 2006: VO₂max 58–68 mL/kg/min', href: '/boxing-science', emoji: '🥊' },
      ...
      { label: 'Wrestling Science', desc: 'Match physiology, takedown biomechanics, weight cutting & injury prevention — Yoon 2002: HR 175–190 bpm, lactate 8–14 mmol/L; Fogelholm 1994: 5% dehydration −9.5% anaerobic power; Wroble 1996: knee injuries 28% of all injuries', href: '/wrestling-science', emoji: '🤼' },
      ...
      { label: 'Jump Rope Science', desc: 'Metabolic demand, neuromotor coordination & athlete applications — Baker 1999: 120 RPM = 11–12 METs (≈ running 8 mph); Ozer 2011: 22–30% coordination gain vs running; double unders reach 200 RPM, 15–18 kcal/min', href: '/jump-rope-science', emoji: '🔬' },
      { label: 'Jump Rope', desc: 'Skipping sessions, kcal/min intensity & weekly volume', href: '/jump-rope', emoji: '🪢' },
      { label: 'Handwashing Science', desc: 'Infection prevention, Apple Watch detection algorithm & WHO 20-second evidence — Ejemot 2008 Cochrane: 31–47% reduction in diarrheal disease; Curtis 2003: 20–30% of respiratory virus spread via hand contact; watchOS 7 ML: 85–90% sensitivity', href: '/handwashing-science', emoji: '🔬' },
      ...
      { label: 'XC Skiing Science', desc: "World's highest VO₂max sport: physiology, polarized training & altitude — Ingjer 1991: Dæhlie 96 mL/kg/min; Seiler 2009: 80/20 polarization; Holmberg 2005: double-poling 500–700 W; Stray-Gundersen 1992: LHTL +5% hemoglobin", href: '/xc-skiing-science', emoji: '⛷️' },
      ...
      { label: 'Fiber Type Science', desc: 'ST/FT physiology, ACTN3 genetics & sport-specific profiles — Costill 1976: 73% ST in elite marathoners vs 24% in sprinters; Simoneau 1995: 70% genetic; Bouchard 2015: VO₂max trainability varies 4× by genotype; Yang 2003: ACTN3 speed gene', href: '/fiber-type-science', emoji: '🔬' },
      ...
      { label: 'American Football Science', desc: 'Positional demands, CTE, strength & energy systems — Brechue 2010: NFL Combine profiles; McKee 2023: CTE in 110/111 donated brains; Mihalik 2011: neck strength −33% head G; Davis 2004: WR VO₂max 52–60 mL/kg/min', href: '/american-football-science', emoji: '🏈' },
      ...
      { label: 'Track & Field Science', desc: 'Sprint biomechanics, energy systems by event, field events & periodization — Haugen 2019: ≤80 ms ground contact; Jones 2000: 100m 100% anaerobic; Morin 2011: horizontal force key; Dapena 1988: Fosbury Flop physics', href: '/track-field-science', emoji: '🏃' },
      ...
      { label: 'Surfing Science', desc: 'Paddle physiology, wave riding biomechanics & injury prevention — Farley 2012: paddling = 54% of session; Nathanson 2002: board impact = 55% of injuries; Mendez-Villanueva 2006: paddling at 70–78% VO₂max', href: '/surfing-science', emoji: '🏄' },
      ...
      { label: 'Blood Oxygen Science', desc: 'SpO₂ physiology, hypoxia mechanisms, altitude acclimatization & sleep apnea detection — Young 1993 NEJM: 80% of OSA undiagnosed; Levine 1997: LHTI altitude protocol', href: '/blood-oxygen-science', emoji: '🔬' },
      { label: 'Blood Oxygen Deep Dive', desc: '30-day SpO₂ trend, nighttime avg, low alerts & reference ranges', href: '/oxygen/deep-dive', emoji: '🫁' },
      { label: 'Pilates Science', desc: 'Core anatomy, back rehabilitation, neuromotor control & Pilates vs yoga — Wells 2014: LBP −36%; Hodges 1996: multifidus feedforward activation; McGill Big 3 core endurance ratios', href: '/pilates-science', emoji: '🔬' },
