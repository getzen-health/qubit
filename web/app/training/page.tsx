...
export default async function TrainingPage() {
  ...
  return (
    <main role="main" aria-label="Training Plans" id="main-content">
      ...
      <a href="/training/hr-zones" className="inline-block mb-6 px-4 py-2 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-colors">Heart Rate Zone Guide</a>
